...
public class CustomRendererRight extends DefaultTableCellRenderer {

    private static final long serialVersionUID = 6703872492730589499L;
        int answer = 0;
        
    public CustomRendererRight(int i) {
        this.answer = i;
//        setHorizontalAlignment(JTable.RIGHT_ALIGNMENT);
    }
...
//                       cellComponent.setForeground(Color.white);  
//        }
        cellComponent.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
