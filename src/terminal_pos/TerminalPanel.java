...
import common_classes.ClockPane;
import common_classes.TimePanel;
 ...
 */
public class TerminalPanel extends javax.swing.JFrame {
...
//             jPanel4.add(new TimePanel());
//             jLabel9.setText("eee");
        setDate();
        tcolumns();
//             jLabel9.setText(new TimePanel());

        this.repaint();
    }

    public TerminalPanel(Connection conn, String unos, String string) {
        initComponents();
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    public void tcolumns() {
    TableColumn column = null;
    int row;
    for (int i = 0; i < 3; i++) {
        row = jTable1.getRowHeight();
...
//                System.out.println(date); //15/10/2013
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Pionir SU\\Documents\\NetBeansProjects\\nkpos\\src\\pictures\\smartPOS2.jpg")); // NOI18N
        ...
        jPanel10Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel2, jLabel4});
        ...
        jPanel10Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel2, jLabel4});

        jLabel4.getAccessibleContext().setAccessibleName("");
        jLabel4.getAccessibleContext().setAccessibleDescription("Label1");
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButton14, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE))
                    .addGroup(jPanel11Layout.createSequentialGroup()
        ...
        jPanel11Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jButton1, jButton10, jButton11, jButton12, jButton13, jButton14, jButton2, jButton3, jButton4, jButton5, jButton6, jButton7, jButton8, jButton9});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TerminalPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                // new TerminalPanel().setVisible(true);
                TerminalPanel tm = new TerminalPanel();
                tm.setExtendedState(JFrame.MAXIMIZED_BOTH);

                tm.add(new ClockPane());
                tm.jPanel2.add(new ClockPane());
                tm.setVisible(true);
