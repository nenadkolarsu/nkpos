...
--
-- Host: localhost
-- Generation Time: Jul 04, 2017 at 08:22 PM
...
CREATE TABLE IF NOT EXISTS `artikli` (
  ...
  `sifra2` varchar(254) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `artikli` (`id`, `jedinica_mere_id`, `poruka_id`, `poreska_grupa_id`, `odeljenje_id`, `artikal_kategorija_id`, `artikal_tip_id`, `sifra`, `naziv`, `aktivan`, `datum_vreme`, `napomena`, `user_id`, `allow_placanje_vaucher`, `vaucher_procenat`, `vaucher_iznos`, `vaucher_iznos_procenat_flag`, `rezervav1`, `rezervav2`, `rezervav3`, `rezervai1`, `rezervai2`, `rezervai3`, `rezervad1`, `rezervad2`, `rezervad3`, `artiklicol`, `sifra2`) VALUES
(1, 1, 1, 1, 1, 1, 1, '1', 'jedan', 1, '2017-07-01 15:58:22', 'napomena', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ''),
(2, 1, 1, 1, 1, 1, 1, '2', 'dva', 1, '2017-07-04 19:48:41', 'napomena', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '');
...
CREATE TABLE IF NOT EXISTS `cenovnik` (
  ...
  `artikal_sifra` varchar(45) COLLATE utf8_bin NOT NULL,
  `datum` datetime NOT NULL,
  `nabavna_cena` decimal(10,0) DEFAULT NULL,
  `planska_cena` decimal(10,0) DEFAULT NULL,
  `prodajna_cena` decimal(10,0) DEFAULT NULL,
  `maloprodajna_cena_bez_pdv` decimal(10,0) DEFAULT NULL,
  `maloprodajna_cena` decimal(10,0) DEFAULT NULL,
  `aktivan` tinyint(1) NOT NULL DEFAULT '1',
  `datum_vreme` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `slika` varchar(254) COLLATE utf8_bin DEFAULT NULL,
  `video` varchar(254) COLLATE utf8_bin DEFAULT NULL,
  `zvuk` varchar(254) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=3 ;
...
INSERT INTO `cenovnik` (`id`, `artikal_id`, `artikal_sifra`, `datum`, `nabavna_cena`, `planska_cena`, `prodajna_cena`, `maloprodajna_cena_bez_pdv`, `maloprodajna_cena`, `aktivan`, `datum_vreme`, `slika`, `video`, `zvuk`) VALUES
(1, 1, '1', '2017-07-01 00:00:00', NULL, NULL, NULL, NULL, '1', 1, '2017-07-01 02:21:19', NULL, NULL, NULL),
(2, 2, '2', '2017-07-04 00:00:00', '2', '2', '2', '2', '2', 1, '2017-07-04 17:49:44', NULL, NULL, NULL);
...
INSERT INTO `jedinica_mere` (`id`, `sifra`, `naziv`, `napomena`, `datum_vreme`, `aktivan`, `deljiva`) VALUES
(1, '1', 'Kilogram', NULL, '2017-06-29 11:34:09', 1, 1),
(2, '2', 'Komada', NULL, '2017-06-29 11:34:17', 1, 1),
(3, '3', 'Tona', NULL, '2017-06-29 11:34:52', 1, 1),
(4, '4', 'Litar', NULL, '2017-06-29 11:35:02', 1, 1),
(5, '5', 'Metar dužni', NULL, '2017-06-29 11:35:22', 1, 1),
(6, '6', 'Metar kvadratni', NULL, '2017-06-29 11:35:37', 1, 1),
(7, '7', 'Metar kubni', NULL, '2017-06-29 11:35:44', 1, 1);
...
INSERT INTO `odeljenje` (`id`, `sifra`, `naziv`, `datum_vreme`, `aktivan`) VALUES
(1, '1', 'Prodavnica 5', '2017-06-29 11:41:08', 1);
...
INSERT INTO `poreska_tarifa` (`id`, `sifra`, `naziv`, `procenat`, `fiksno`, `aktivan`, `napomena`, `pdv`, `porez_indikator`, `datum_od`) VALUES
(1, 'A', NULL, '0.00', NULL, 1, NULL, NULL, NULL, NULL);
...
(6, '1000', 'Zagreb', 3, 2, 'Hrvatska', '2017-06-30 09:51:37', 1),
(7, '23000', 'Zrenjanin', 6, 4, 'BIH', '2017-06-30 09:42:21', 1),
(14, '100', 'Szeged', 5, 3, 'Madjarska', '2017-06-30 09:41:58', 1),
...
(185, '12', '12', 7, 5, 'Italija', '2017-06-30 09:33:15', 1);
...
INSERT INTO `tip_artikla` (`id`, `sifra`, `naziv`, `napomena`, `datum_vreme`, `aktivan`) VALUES
(1, '1', 'Standardni', NULL, '2017-06-29 11:17:25', 1),
(2, '2', 'Sa serijskim brojem', NULL, '2017-06-29 11:17:40', 1),
(3, '3', 'Sa varijacijama', NULL, '2017-06-29 11:18:05', 1),
(4, '4', 'Usluga', NULL, '2017-06-29 11:18:14', 1),
(5, '5', 'Materijal', NULL, '2017-06-29 11:18:31', 1);
...
CREATE TABLE IF NOT EXISTS `zaliha` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `magacin_id` int(11) NOT NULL,
  `artikal_id` int(11) NOT NULL,
  `ulazni_dokument` varchar(254) COLLATE utf8_bin DEFAULT NULL,
  `izlazni_dokument` varchar(254) COLLATE utf8_bin DEFAULT NULL,
  `ulazna_kolicina` decimal(10,0) DEFAULT NULL,
  `izlazna_kolicina` decimal(10,0) DEFAULT NULL,
...
INSERT INTO `zaliha` (`id`, `magacin_id`, `artikal_id`, `ulazni_dokument`, `izlazni_dokument`, `ulazna_kolicina`, `izlazna_kolicina`, `kolicina`, `aktivan`, `datum_vreme`) VALUES
(1, 1, 1, '', '', '1', '0', '1', 1, '2017-07-01 02:17:16'),
(2, 1, 2, NULL, NULL, '1', NULL, '2', 1, '2017-07-01 02:19:06');
